    ...
    def forward(ctx, use_time_mask, is_training, heads, inputs, input_weights, output_weights, input_biases, output_biases, pad_mask, mask_additive, dropout_prob):
        ...
        if use_biases_t[0]:
            if not mask_additive:
                ...
                matmul2_results,                                                \
                outputs = \
                    fast_self_multihead_attn_bias.forward(use_mask, use_time_mask,, is_training, heads
            else:
                input_lin_results,                                              \
                softmax_results,                                                \
                dropout_results,                                                \
                ...
                matmul2_results,                                                \
                outputs = \
                    fast_self_multihead_attn_bias_additive_mask.forward(use_mask, use_time_mask,, is_training, heads
            ...
            matmul2_results,                                                \
            outputs = \
                fast_self_multihead_attn.forward(use_mask, use_time_mask,, is_training, heads
