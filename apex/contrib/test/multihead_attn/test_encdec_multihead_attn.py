...
class EncdecMultiheadAttnTest(unittest.TestCase):
    ...
    def test_encdec_multihead_attn(self) :
        ...
        ref_outputs,_ = self.ref_layer.forward(self.ref_inputs_q, self.ref_inputs_k,, self.ref_inputs_k

        tst_outputs,_ = self.tst_layer.forward(self.tst_inputs_q, self.tst_inputs_k,, self.tst_inputs_k
