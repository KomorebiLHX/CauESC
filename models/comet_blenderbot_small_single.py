...
from .executors import BlenderbotSmallDecoderWithExecutor, BlenderbotSmallDecoderWithSmallExecutor
    ...
    def generate(
        ...
        **kwargs
        ...
        encoded_info.update({
            ...
            'pred_strategy_id_top2': torch.topk(strategy_score, k=2, dim=-1)[1],
            'pred_strategy_id_top3': torch.topk(strategy_score, k=3, dim=-1)[1],
            'pred_strategy_id_top4': torch.topk(strategy_score, k=4, dim=-1)[1],
            'pred_strategy_id_top5': torch.topk(strategy_score, k=5, dim=-1)[1],
